...
import { faArrowRightLong, faBus, faCalendarAlt, faLeftRight, faMinus, faPlane, faPlus, faRightLeft, faTrain, faTruckPlane } from '@fortawesome/free-solid-svg-icons';
            ...
            <Box sx={{ width: '100%', typography: 'body1' }}>
              <TabContext value={value}>
                ...
                <TabPanel className='TabPanel' value="1">
                  ...
                  <div class="card direction-phone p-2 my-2 m-auto">
